export const buildKycApprovedTemplate = (
  name: string,
  assignedTier: string,
  creditLimit: number
) => {
    ...
    >
      ...
      >
        ...
        <p
          ...
          "
        >
          The go-to partner for precious metals investments
        </p>
      ...
      >
        ...
        >
          ...
          successfully approved. Your account is now active and ready for
          trading on the NUI platform.
        </p>
        ...
        >
          ...
          >
            ...
            <tr>
              <td colspan="2">
                <div style="height: 1px; background: #e8d89a;"></div>
              </td>
            </tr>
        ...
        >
          ...
          >
            ...
            <a
              href="tel:5167984170"
              style="color: #8a6820; text-decoration: none;"
            >
              (516) 798.4170
            </a>
          </p>
      ...
      >
        ...
        <p
          ...
          "
        >
          © 2026 Numismatics Unlimited Inc. · Est. 1990
        </p>
