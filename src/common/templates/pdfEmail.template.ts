export const buildPdfEmailTemplate = (filename: string): string => {
  return `
  <style>
    ...
    >
      ...
      >
        ...
        >
          ...
          You may open or download it directly from your email client.
        </p>
        ...
        >
          <p
            ...
            "
          >
            If you were not expecting this document or believe you received
            this email in error, please contact us immediately.
          </p>
        </div>
