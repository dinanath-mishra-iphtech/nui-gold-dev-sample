export const buildPurchaseOrderConfirmationTemplate = ({
  vendorName,
  purchaseOrderNumber,
}: {
  vendorName: string;
      ...
      >
        ...
        <h1
          ...
          style="
            ...
            line-height: 1.2;
          "
        >Purchase Order Confirmation</h1>
        ...
        <p
          ...
          "
        >
          Dear <strong style="color: #1a1400;">${vendorName}</strong>,
        </p>
        ...
        <p
          ...
          "
        >
          We are pleased to confirm that a purchase order has been issued
          to you by Numismatics Unlimited Inc. Please find the order
          details below, along with a copy of the purchase order attached
        ...
        >
          <p
            ...
            "
          >
            A PDF copy of the purchase order is attached to this email.
            Please review the order details carefully. If you have any
            discrepancies or concerns, contact us at
