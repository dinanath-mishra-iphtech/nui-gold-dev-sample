...
export const env = {
  ...
  /** Metals-API access key for fetching live spot prices */
  METALS_API_KEY: process.env.METALS_API_KEY || "",

  /** Spot price polling interval in milliseconds (default: 5000) */
  METALS_API_POLL_INTERVAL_MS:
    Number(process.env.METALS_API_POLL_INTERVAL_MS) || 5000,

  /** Use mock spot prices instead of hitting the real API (default: true) */
  METALS_API_MOCK: process.env.METALS_API_MOCK !== "false",
};